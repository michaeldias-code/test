...
privacyStack: {
    ...
    content: `
        ...
        <div class="project-highlights" style="margin: 30px 0; border-left: 4px solid #ffc107; padding: 20px;">
        ...
        <div class="project-highlights" style="margin: 30px 0; border-left: 4px solid #0c5460; padding: 20px;">
        ...
        <div class="project-highlights" style="margin: 20px 0; background: #f8d7da; border-left: 4px solid #dc3545; padding: 20px;color: #721c24;">
...
contributingGuide: {
	...
	content: `
		...
		<div class="project-highlights" style="margin: 30px 0; background: #d1ecf1; border-left: 4px solid #0c5460; padding: 20px; color: #0c5460;">
...
readingCodeGuide: {
    ...
    content: `
        ...
        <div class="project-highlights" style="margin: 30px 0; border-left: 4px solid #dc3545; padding: 20px;">
...
licensesGuide: {
    ...
    content: `
        ...
        <div class="project-highlights" style="margin: 30px 0; background: #fff3cd; border-left: 4px solid #ffc107; padding: 20px; color: #856404;">
