...
class AI_Hard {
    constructor() {
        // Configurações específicas da AI_Hard
     ...
     * Implementa a lógica de cálculo para o nível 'hard'.
    ...
    findMove(boardState, playerColor) {
        console.log(`🤖 AI_Hard: Calculando movimento (Profundidade: ${this.searchDepth})...`);
        ...
        console.log(`🎉 AI_Hard: Movimento escolhido aleatoriamente: ${JSON.stringify(bestMove)}`);
        return bestMove;
    }
